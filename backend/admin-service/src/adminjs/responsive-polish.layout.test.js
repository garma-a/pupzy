...
describe('Task 12: Finish Responsive Pupzy States & Browser Polish', () => {
  ...
  describe('Anti-Collapse & Character Squeezing Guarantees across all 23 tables', () => {
    it('ensures ADMIN_RESOURCE_TABLES contains all 23 curated tables', () => {
      assert.equal(ADMIN_RESOURCE_TABLES.length, 23);
    });

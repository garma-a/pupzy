...
describe("AdminJS Saved Searches Resource Configuration", () => {
  ...
  it("attaches ShortUuid custom component to ID and relation fields when provided", () => {
    ...
    assert.equal(
      res.options.properties.id.components.list,
      "CustomShortUuidComponent",
    );
    assert.equal(
      res.options.properties.id.components.show,
      "CustomShortUuidComponent",
    );
    assert.equal(
      res.options.properties.user_id.components.list,
      "CustomShortUuidComponent",
    );
    assert.equal(
      res.options.properties.user_id.components.show,
      "CustomShortUuidComponent",
    );
  });

...
function formatCoordinateForError(coord) {
 ...
 *
 * @param {unknown} latitude - Latitude coordinate (number or numeric string)
 * @param {unknown} longitude - Longitude coordinate (number or numeric string)
 * @returns {{ latitude: number, longitude: number }} Validated numeric coordinates
 ...
 *
 * @param {unknown} latitude - Latitude coordinate
 * @param {unknown} longitude - Longitude coordinate
 * @returns {boolean} true if valid finite WGS84 coordinates, false otherwise
 */
export function isValidWgs84Coordinates(latitude, longitude) {
  try {
 ...
 *
 * @param {unknown} latitude - WGS84 latitude (-90 to 90)
 * @param {unknown} longitude - WGS84 longitude (-180 to 180)
 * @returns {string} Canonical Google Maps URL string
 ...
 *
 * @param {unknown} latitude - WGS84 latitude
 * @param {unknown} longitude - WGS84 longitude
 * @returns {string | null} Canonical Google Maps URL string or null
 */
export function tryBuildGoogleMapsUrl(latitude, longitude) {
  try {

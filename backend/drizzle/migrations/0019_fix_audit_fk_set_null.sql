...
-- 2. Enforce NOT NULL on all attribution columns
ALTER TABLE "vet_clinic_location_audits"
...
-- 3. Re-add foreign keys with ON DELETE RESTRICT ON UPDATE CASCADE
ALTER TABLE "vet_clinic_location_audits"
...
-- 4. Append-only protection: prevent any direct UPDATE or DELETE on committed audits.
